...
class InvalidInstructionError extends _baseError.default {
  constructor(...args) {
    super(...args);
  }
  ...
  readHeader(chunk) {
    ...
    switch (this.headerPos) {
      case 0:
        ...
        if (!_opCodes.default.list.has(opCode)) {
...
exports.default = InstructionReader;